...
function createGrid(options = {}) {
  ...
  const Grid4 = React13.forwardRef(function Grid5(inProps, ref) {
...
function createStack(options = {}) {
  ...
  const Stack2 = React14.forwardRef(function Grid4(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
var GridContext = React16.createContext();
if (true) {
...
var Grid2 = React17.forwardRef(function Grid3(inProps, ref) {
  ...
  const columnsContext = React17.useContext(GridContext_default);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XQV4E4FM.js.map
